 ...
 *
 * Original implementation by Sebastian Wiesinger (gsnw-sebast)
 * https://github.com/gsnw-sebast
 *
 * Enhanced with pretty-print support and test coverage by
 * Josh F (AthenaNetworks)
 *
